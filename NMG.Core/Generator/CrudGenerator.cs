...
{
    public class CrudGenerator : AbstractGenerator
    {
        private readonly ApplicationPreferences appPrefs;
        private readonly Language language;

        public CrudGenerator(ApplicationPreferences appPrefs, Table table)
            : base(appPrefs.DomainFolderPath, "Crud", appPrefs.TableName, appPrefs.NameSpaceCrud, appPrefs.AssemblyName, appPrefs.Sequence, table, appPrefs)
        {
